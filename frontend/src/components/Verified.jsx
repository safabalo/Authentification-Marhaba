...
function Verified() {
  ...
  return (
    <div className="lg:bg-[url('../public/neutral.png')] bg-cover w-screen h-screen flex justify-center items-center flex-col">
        ...
        <button className='rounded-full bg-red-500 active:bg-red-600 active:text-white text-white w-32 p-2 hover:text-red-600 font-bold hover:bg-white border-2 border-red-500' onClick={handleClick}>
            back to login
        </button>
        <ToastContainer />
    </div>
