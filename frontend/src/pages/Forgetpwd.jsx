    ...
    <div className="lg:bg-[url('../public/neutral.png')] bg-cover w-screen h-screen flex justify-center items-center">
      <div className='w-7/12 flex justify-center items-center bg-white h-4/5 rounded-3xl'>
        <form className='bg-white flex flex-col w-1/2' onSubmit={handleSubmit}>
          <h1 className="text-center my-5 font-extrabold text-red-600 text-2xl font-mono">Forget password</h1>
          <label htmlFor="email">
          ...
          <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} name="email" id="email" className=' block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none  focus:ring-sky-500 focus:ring-1 sm:text-sm  hover:border-2  hover:border-cyan-500' />
